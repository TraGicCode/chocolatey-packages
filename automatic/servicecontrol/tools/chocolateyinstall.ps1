...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.19.2/Particular.ServiceControl-6.19.2.exe'
$checksum64    = 'eb925decbf6bb149e8dd17e39a55b7462218f88d77acfadcb7bd9a6f5f5455a7'
