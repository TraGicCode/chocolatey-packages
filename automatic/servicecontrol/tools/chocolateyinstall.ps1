...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.19.1/Particular.ServiceControl-6.19.1.exe'
$checksum64    = '466653ec32192a5e10462f0d73d2ca1ebb3f873a7059ab7d262542d633b6b2e1'
