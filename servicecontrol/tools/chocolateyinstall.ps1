...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.15.0/Particular.ServiceControl-6.15.0.exe'
$checksum64    = '08f36642ed9af265077299437b1a193ca657ed827e9f247bb34ded977a432e4c'
