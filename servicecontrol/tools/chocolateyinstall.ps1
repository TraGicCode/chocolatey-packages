...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.9.0/Particular.ServiceControl-6.9.0.exe'
$checksum64    = '87bcf83b13765764c6303b7debe2686d4af4f359f9d6018213866d5f071cd5ee'
