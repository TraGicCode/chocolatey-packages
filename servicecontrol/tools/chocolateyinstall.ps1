...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.18.0/Particular.ServiceControl-6.18.0.exe'
$checksum64    = 'a2ab607dc4779a2f682579ec242e3cebc757d2ae23468a84755dfd381bb4f8f9'
