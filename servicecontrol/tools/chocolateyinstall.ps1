...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/5.2.1/Particular.ServiceControl-5.2.1.exe'
$checksum64    = '2b415b2ae1bbfa874e8680114e1f71abc66a6206d5fc2941b962067c9660adf9'
