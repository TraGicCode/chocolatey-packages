...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.6.1/Particular.ServiceControl-6.6.1.exe'
$checksum64    = '7293ca6baf2def590bbccc879a9df81540020baf31cc315338b00f61e2316ccb'
