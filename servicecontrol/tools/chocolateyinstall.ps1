...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/5.4.1/Particular.ServiceControl-5.4.1.exe'
$checksum64    = '1d9f3ca7283b30f7bb7da3a57e9afdf179e7453f5973655a13bfcbe6b11a2cfb'
