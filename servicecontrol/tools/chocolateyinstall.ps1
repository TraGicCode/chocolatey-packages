...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.16.0/Particular.ServiceControl-6.16.0.exe'
$checksum64    = 'e6e6e91dbdb15a06e8d8c7019ef40b32ea4988e36b536574caedcb5b91e82860'
