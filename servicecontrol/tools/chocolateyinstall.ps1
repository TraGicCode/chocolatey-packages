...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.12.0/Particular.ServiceControl-6.12.0.exe'
$checksum64    = 'f94b8ecc19266aff3d33044ab9a8125c45b686af3fd30eb2b18d6a122d2dc601'
