...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.5.3/Particular.ServiceControl-6.5.3.exe'
$checksum64    = '2abec92970b3c9a744542d239ee4199e66ba001a376a813c4d146cd5f04216d4'
