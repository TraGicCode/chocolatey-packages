...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.6.3/Particular.ServiceControl-6.6.3.exe'
$checksum64    = '97a64add658e3e23fff9748c3d92fef806b611ef4dadb0fc68a4da6633fa3df0'
