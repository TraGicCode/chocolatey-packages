...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.1.0/Particular.ServiceControl-6.1.0.exe'
$checksum64    = '6302a5d624407781ee5a1938094c6ff84a5911e67763bcac81373d865467c779'
