...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.18.3/Particular.ServiceControl-6.18.3.exe'
$checksum64    = 'a3701cf188656d4ff9d0eb0ada2ed31b6d70a13cfd342f29a01af45d4e95a49c'
