...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.7.1/Particular.ServiceControl-6.7.1.exe'
$checksum64    = 'cb0df7b3d06e38a94562755321b26182e36a260519fc3fc40effc980b23104a7'
