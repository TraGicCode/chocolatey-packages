...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.3.1/Particular.ServiceControl-6.3.1.exe'
$checksum64    = '9383fcf12f61322144d935aa1317363aa16f510613794bc6826462f6dd5d0641'
