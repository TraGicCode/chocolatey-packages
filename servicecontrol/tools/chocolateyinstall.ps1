...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.0.1/Particular.ServiceControl-6.0.1.exe'
$checksum64    = '06f8ea3feaf7051c8cc42a2a7d767349fe884febb3aeb536044c940399e5f4a7'
