...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/6.9.1/Particular.ServiceControl-6.9.1.exe'
$checksum64    = 'dfc43c41cafd3ff0d25f0ffd5602a7d7f501155a5f90b2e4567003bee7a9180b'
