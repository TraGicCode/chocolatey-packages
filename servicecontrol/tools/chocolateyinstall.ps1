...
$url64bit      = 'https://github.com/Particular/ServiceControl/releases/download/5.0.5/Particular.ServiceControl-5.0.5.exe'
$checksum64    = '7661da2091fb978891ac5b8abddab3613ca1487d619ebe79572e7fd473fc5279'
